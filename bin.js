...
process.title = '@navify/swiftlint';
...
const { Subprocess } = require('@navify/utils-subprocess');
const { writeJson } = require('@navify/utils-fs');
...
const getConfigPath = async () => {
  try {
    const explorer = cosmiconfig('@navify/swiftlint');
